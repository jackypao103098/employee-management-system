...
- 🔷 **C#／ASP.NET Core**：獨立重構版本，包含 EF Core、PostgreSQL、JWT、xUnit 與 React 串接。[查看 .NET Side Project](https://github.com/jackypao103098/employee-management-system/tree/dotnet-interview-v3/employee-management-dotnet)
